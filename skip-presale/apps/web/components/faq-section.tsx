const faqs = [
  ...
  ["When can I claim?", "Claims are enabled only after the presale is finalized successfully and the softcap is reached."],
  ...
  ["Why can 25% be used during presale?", "A transparent development unlock can fund infrastructure, design, legal review and community growth during the presale."],
